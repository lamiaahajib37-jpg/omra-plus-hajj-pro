...
import {
  ...
  Search, SlidersHorizontal, TrendingUp, ClipboardList, Plus,
} from "lucide-react";
...
export default function Departements() {
  ...
  const filteredDepts = useMemo(() => {
    ...
    return list;
  }, [search, activeFilter, sortKey, departments]);
  ...
  const handleAddDepartment = (newDept: Omit<Department, "id" | "staff">) => {
