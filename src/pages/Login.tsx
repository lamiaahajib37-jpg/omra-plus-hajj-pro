...
import { Lock, Mail, Eye, EyeOff, Plane, Shield, User } from "lucide-react";
...
export default function Login() {
  ...
  const quickLogin = (role: "admin" | "employee") => {
    if (role === "admin") {
      login("admin@accessmorocco.ma", "admin123");
    } else {
      login("employe@accessmorocco.ma", "employe123");
    }
  };
    ...
    <div className="min-h-screen flex bg-muted/30">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden flex-col items-center justify-center text-primary-foreground p-12">
        ...
        <div className="relative z-10 text-center space-y-8">
          <img src={logo} alt="Access Morocco" className="h-16 mx-auto brightness-0 invert" />
          <div>
          ...
          <div className="grid grid-cols-1 gap-4 max-w-sm mx-auto mt-8">
            ...
            <div className="flex items-center gap-3 bg-white/10 rounded-lg px-4 py-3">
              ...
              <span className="text-sm">Espace Administrateur & Employé</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center lg:hidden mb-6">
            <img src={logo} alt="Access Morocco" className="h-10 mx-auto mb-3" />
          </div>
          ...
          <Card className="border-dashed border-2 border-primary/30 bg-primary/5">
            ...
            <CardContent className="space-y-2 pb-4">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-lg border border-border bg-background hover:bg-accent transition-colors text-left"
              >
